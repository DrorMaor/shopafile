<table>
    <tr>
        ...
        <td class="TopPadding" onclick="PopupFormDisplay(true, 'FAQ');"><span class="MenuItem">FAQ</span></td>
        <td class="TopPadding" onclick="PopupFormDisplay(true, 'ItsFree');"><span class="MenuItem">It's FREE</span></td>
        <td class="TopPadding" id="tdLogin" onclick="PopupFormDisplay(true, 'LoginForm');"><a class="MenuItem" id="menuLogin">Login</a></td>
